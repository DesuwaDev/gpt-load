...
func (s *Server) HTTPModule() httproute.Module {
	return httproute.Module{
		...
		Routes: []httproute.Route{
			...
			controlRoute(
				"control.degradation.overview",
				http.MethodGet,
				"/degradation/overview",
				s.handleDegradationOverview,
			),
			controlRoute(
				"control.degradation.settings.update",
				http.MethodPut,
				"/degradation/settings",
				s.auditMutation(newMutationDescriptor(
					"degradation_settings_update",
					"degradation_settings",
					staticMutationLocator("degradation:settings"),
				)),
				s.handleUpdateDegradationSettings,
			),
			controlRoute(
				"control.degradation.monitors.list",
				http.MethodGet,
				"/degradation/monitors",
				s.handleListDegradationMonitors,
			),
			controlRoute(
				"control.degradation.monitors.enroll",
				http.MethodPost,
				"/degradation/monitors",
				s.auditMutation(newMutationDescriptor(
					"degradation_monitor_enroll",
					"degradation_monitor",
					staticMutationLocator("degradation-monitor:batch"),
				)),
				s.handleEnrollDegradationMonitors,
			),
			controlRoute(
				"control.degradation.monitors.batch",
				http.MethodPost,
				"/degradation/monitors/batch",
				s.auditMutation(newMutationDescriptor(
					"degradation_monitor_batch",
					"degradation_monitor",
					staticMutationLocator("degradation-monitor:batch"),
				)),
				s.handleBatchDegradationMonitors,
			),
			controlRoute(
				"control.degradation.monitors.update",
				http.MethodPut,
				"/degradation/monitors/:monitor_id",
				s.auditMutation(newMutationDescriptor(
					"degradation_monitor_update",
					"degradation_monitor",
					degradationMonitorMutationLocator,
				)),
				s.handleUpdateDegradationMonitor,
			),
			controlRoute(
				"control.degradation.monitors.delete",
				http.MethodDelete,
				"/degradation/monitors/:monitor_id",
				s.auditMutation(newMutationDescriptor(
					"degradation_monitor_delete",
					"degradation_monitor",
					degradationMonitorMutationLocator,
				)),
				s.handleDeleteDegradationMonitor,
			),
			controlRoute(
				"control.degradation.monitors.run",
				http.MethodPost,
				"/degradation/monitors/:monitor_id/run",
				s.auditMutation(newMutationDescriptor(
					"degradation_monitor_run",
					"degradation_monitor",
					degradationMonitorMutationLocator,
				)),
				s.handleRunDegradationMonitor,
			),
			controlRoute(
				"control.degradation.monitors.runs",
				http.MethodGet,
				"/degradation/monitors/:monitor_id/runs",
