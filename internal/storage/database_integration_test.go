...
func TestExternalDatabaseLifecycle(t *testing.T) {
	...
	if len(migrationIDs) != 19 || migrationIDs[0] != "0001_initial" ||
		...
		migrationIDs[8] != "0009_price_multipliers" || migrationIDs[9] != "0010_model_cooldown" || migrationIDs[10] != "0011_custom_access_keys" || migrationIDs[11] != "0012_access_key_mask_prefix" || migrationIDs[12] != "0013_validation_protocol" || migrationIDs[13] != "0014_access_key_concurrency_limit" || migrationIDs[14] != "0015_credential_limits" || migrationIDs[15] != "0016_group_credential_limits" || migrationIDs[16] != "0017_credential_marks" || migrationIDs[17] != "0018_affinity_kind" || migrationIDs[18] != "0019_degradation_monitors" {
